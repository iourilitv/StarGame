...
import gdx.lessons.lesson2.hw.screen.MenuScreen;
 ...
 * ext1. Добавлена цикличность движения, т.е. при касании изображения края скрина с одной стороны
 *     оно появляется с противоположной.
