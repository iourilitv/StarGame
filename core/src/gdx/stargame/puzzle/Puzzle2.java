...
/**
 * Puzzle2.
 * Screen filling with pieces of the picture in normal order.
 * version 1. Started from the down-left corner
 * version 2. Started from the up-left corner
 */
public class Puzzle2 extends ApplicationAdapter {
...
//		float y = REGION_HEIGHT * k;
		//TODO version 2. Started from the up-left corner
