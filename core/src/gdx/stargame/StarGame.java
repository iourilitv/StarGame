 ...
 * DONE 4b. Добавить звук при попадании снаряда в корабль(всем).
 ...
 * DONE 6a. Вывести на экран сохраненные значения максимальных результов
 *    набранных в игре очков и достигнутого уровня.
 * DONE 7. Добавить. Вывод значений жизни(остатка и максимально возвожного на текущем уровне)
 *    на корабли противника.
 * 8. Добавить. Ввод настроек. или DONE скорректировать в ручную.
 * >>> Окончание игры.
